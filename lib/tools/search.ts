...
export function createSearchTool(fullModel: string) {
  return tool({
    description:
      'Search the web for construction industry information, OSHA violations, NLRB cases, government contracts, company research, and labor relations data. Focus on finding information about construction companies, their safety records, union status, government contracts, and regulatory compliance.',
