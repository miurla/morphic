...
describe('nativeMotion', () => {
  it('keeps native interaction durations short', () => {
    expect(nativeMotion.duration.instant).toBeLessThan(
      nativeMotion.duration.fast
    )
    expect(nativeMotion.duration.fast).toBeLessThan(
      nativeMotion.duration.normal
    )
    expect(nativeMotion.duration.normal).toBeLessThan(
      nativeMotion.duration.sheet
    )
  })
  ...
  it('defines conservative press feedback tokens', () => {
    ...
    expect(nativeMotion.press.subtleScale).toBeGreaterThan(
      nativeMotion.press.scale
    )
