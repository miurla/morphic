...
An AI-powered search engine with a generative UI, built with Vercel AI SDK RSC.

> [!NOTE]
> This is an experimental version using Vercel AI SDK RSC, which has some limitations. For production use, please consider using the main version in the parent directory.
...
- Text streaming / Generative UI: [Vercel AI SDK RSC](https://sdk.vercel.ai/docs/ai-sdk-rsc)
...
Follow the guide below to set up Upstash Redis. Create a database and obtain `UPSTASH_REDIS_REST_URL` and `UPSTASH_REDIS_REST_TOKEN`. Refer to the [Upstash guide](https://upstash.com/blog/rag-chatbot-upstash#setting-up-upstash-redis) for instructions.
