...
// Uses shadcn/Tailwind CSS-variable tokens defined in globals.css.
// ─────────────────────────────────────────────────────────────────────────

export const metadata_note = null // metadata lives in a separate server file
...
// Custom Morphic Logo Component
function MorphicLogo({ className = 'h-16 w-16' }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 200 200"
      fill="none"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* floating Morphic Logo glyph, sits slightly "above" the glass on Z axis */}
        <div
          className="absolute inset-0 flex items-center justify-center"
          style={{ transform: 'translateZ(40px)' }}
        >
          <MorphicLogo className="h-16 w-16 drop-shadow-xl sm:h-20 sm:w-20" />
        </div>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden px-6 pb-24 pt-20 sm:pb-32 sm:pt-28">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            {/* right: 3D orb with Morphic logo */}
